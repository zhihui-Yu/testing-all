...
public class RabbitMQConfig {
    ...
    public RabbitTemplate rabbitTemplate() {
        ...
        rabbitTemplate.setReturnCallback(new RabbitTemplate.ReturnCallback() {
            ...
            public void returnedMessage(Message message, int i, String s, String s1, String s2) {
                log.warn("消息丢失：exchage{},route{},replyCode{},replyText{},message:{}",s1,s2,i,s,message);
            }
        });
    ...
    //基本交换机
    @Bean
    public TopicExchange successKillDeadPridExchange() {
    ...
    public Binding successKillDeadProdBinding(){
        return BindingBuilder.bind(successKillDeadQueue()).to(successKillDeadPridExchange()).with(env.getProperty("mq.kill.item.success.kill.dead.prod.routing.key"));
    }
